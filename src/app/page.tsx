          ...
          <div className="max-w-2xl mx-auto space-y-4 my-4">
            <div className="bg-white rounded-xl border border-slate-200 p-6 shadow-xs">
              ...
              <p className="text-xs text-slate-500 mb-4">
                Track past orders saved in your Firebase account & direct WhatsApp dispatches.
              </p>

              {!currentUser ? (
                <div className="text-center py-10 bg-slate-50 rounded-lg border border-dashed border-slate-300 p-6 space-y-3">
                  <Lock className="w-8 h-8 text-slate-400 mx-auto" />
                  <h3 className="font-bold text-slate-900 text-sm">Sign In to View Orders</h3>
                  <p className="text-xs text-slate-500 max-w-xs mx-auto">
                    Please log in to your account to view your past orders, delivery details, and receipts.
                  </p>
                  <button
                ...
                <div className="text-center py-12">
                  ...
                  <p className="text-xs text-slate-500">Loading your orders from Firebase...</p>
                </div>
              ) : orders.length === 0 ? (
                <div className="text-center py-10 bg-slate-50 rounded-lg border border-slate-200 p-6 space-y-3">
                  <ShoppingBag className="w-8 h-8 text-slate-400 mx-auto" />
                  <h3 className="font-bold text-slate-900 text-sm">No Orders Placed Yet</h3>
                  <p className="text-xs text-slate-500 max-w-xs mx-auto">
                    Items added to cart and checked out will be saved here in your account order history.
                  </p>
                  <button
                  ...
                  {orders.map((order) => (
                    ...
                    >
                      <div className="flex items-center justify-between border-b border-slate-200 pb-2.5">
                        ...
                        <span className="px-2.5 py-1 rounded-full text-[10px] font-bold bg-emerald-100 text-[#043d27] border border-emerald-200 flex items-center gap-1">
          ...
          <div className="max-w-md mx-auto my-4 space-y-4">
            <div className="bg-white rounded-xl border border-slate-200 p-6 space-y-5 shadow-xs">
              <div className="flex items-center gap-3 border-b border-slate-100 pb-4">
                ...
                <div>
                  <div className="font-bold text-slate-900 text-base">
                    {currentUser ? (userData?.name || currentUser.displayName || 'Valued Customer') : 'Guest User'}
                  </div>
                  <div className="text-xs text-slate-500">
                    {currentUser ? currentUser.email : 'Sign in to access your profile'}
                  </div>
                </div>
              </div>
              ...
              {currentUser ? (
                ...
                <button
                  onClick={() => openAuthModal('signin')}
                  className="w-full py-3 bg-[#043d27] text-white font-bold text-xs rounded-lg flex items-center justify-center gap-2 shadow-xs"
                >
                  <UserIcon className="w-4 h-4" />
